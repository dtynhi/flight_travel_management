...
#         except:
#             # Fallback to default values if system parameters not found
#             system_params = {
...
#         # Validate using system parameters
#         all_airport_ids = [a.id for a in Airport.query.all()]
#         if from_airport not in all_airport_ids or to_airport not in all_airport_ids:
#             return jsonify(ErrorApiResponse(message="Sân bay không tồn tại").to_dict()), 400
#         if from_airport == to_airport:
...
#         # Use system parameter for minimum flight duration
#         min_flight_duration = system_params.get('minimum_flight_duration', 30)
...
#         # Use system parameter for max intermediate stops
...
#         # Validate stops using system parameters
...
#             "applied_constraints": {
#                 "minimum_flight_duration": min_flight_duration,
#                 "max_intermediate_stops": max_stops,
#                 "stop_duration_range": f"{min_stop_duration}-{max_stop_duration} minutes"
#             }
#         }).to_dict()), 200
            ...
            try:
                ...
                for ftc in existing_flight_ticket_classes:
                    ...
                    try:
                        ...
                        print(ticket_class_data['priceMultiplier'])
