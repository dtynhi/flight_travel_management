...
class Flight(db.Model):
    ...
    departure_airport_id = db.Column(
        db.Integer, db.ForeignKey("tbl_airports.id"), nullable=False
    )  # ✅ Added FK
    ...
    def to_dict(self):
        ...
        duration_str = (
            self._format_duration(self.flight_duration)
        ...
        return {
            ...
            "departureAirport": (
                ...
                else f"Airport {self.departure_airport_id}"
            ),
            "arrivalAirport": (
                self.arrival_airport.airport_name
                if self.arrival_airport
                else f"Airport {self.arrival_airport_id}"
            ),
            "departureTime": (
